...
SELECT tid, b.designation_d as kategorie, nbident, nummer, geometrie, lagegen, hoehegeom, hoehegen, punktzeichen, to_date(a.stand_am, 'YYYYMMDD') as stand_am, bfsnr
FROM
(
